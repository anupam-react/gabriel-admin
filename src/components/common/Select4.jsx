...
const Select4 = ({selectedOption , handleChange , open , setOpen , typeOfData, handleSave=()=>{} }) => {
        ...
        <div className="p-4 bg-[#F5F5F5] rounded-lg h-80">
          ...
          <div className="flex justify-center items-center gap-10 mt-8">
            <button className="sign-button w-48" onClick={()=>{
              handleSave(typeOfData,selectedOption, formatDate2(startDate), formatDate2(endDate))
              setOpen(false)
              }}>SAVE</button>
