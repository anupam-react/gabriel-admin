...
const ReceiptFilter = ({ closeDrawer, open }) => {
  ...
  return (
          ...
          <div className="filter-body">
            ...
            <div className="checkbox-container">
              ...
              <div className="checkbox-filter">
               ...
               <div className="mt-4">
                <p className="text-lg font-semibold pb-4">Size Range <span className="text-[#000000B2]"> ( in Mb )</span></p>
    ...
    <span className="text-sm text-gray-500 dark:text-gray-400 absolute start-1/4 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6">5 Mb</span>
    <span className="text-sm text-gray-500 dark:text-gray-400 absolute start-2/4 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6">10Mb</span>
    <span className="text-sm text-gray-500 dark:text-gray-400 absolute start-3/4 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6">20Mb</span>
    <span className="text-sm text-gray-500 dark:text-gray-400 absolute end-0 -bottom-6">+30Mb</span>
</div>
              </div>
              <div className="mt-12">
              ...
              <div className="mt-6 cursor-pointer flex justify-center items-center gap-3 rounded-lg py-2 border border-[#0070BC] text-[#0070BC]" onClick={()=> setOpenProfile(!openProfile)}>
