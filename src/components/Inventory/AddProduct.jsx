...
const {name, setName,
  ...
  category,
  subcategory,
  handleCreateProduct} = useProduct()
  ...
  />
        ...
        <div className="mt-4">
          ...
          <input type="text" className="input-loyalty2"  value={sku}
        ...
        <div className="mt-4">
          ...
          <input type="text" className="input-loyalty2"  value={quantity}
            onChange={(e)=> setQuantity(e.target.value)}/>
        </div>
        <div className="mt-4">
          <p className="text-lg font-semibold pb-2">Dimensions and Weight</p>
          <input type="text" className="input-loyalty2" value={dimension}  onChange={(e)=> setDimension(e.target.value)}/>
        </div>
        <div className="mt-4">
          <p className="text-lg font-semibold pb-2">Brand Name</p>
          <input type="text" className="input-loyalty2"  value={brand}
            onChange={(e)=> setBrand(e.target.value)}/>
        </div>
        <div className="mt-4">
          <p className="text-lg font-semibold pb-2">Shipping Information</p>
          <input type="text" className="input-loyalty2"  value={shippingInfo}
            onChange={(e)=> setShippingInfo(e.target.value)}/>
        </div>
        <div className="mt-4">
          <p className="text-lg font-semibold pb-2">Return Policy</p>
          <input type="text" className="input-loyalty2"  value={returnPolicy}
            onChange={(e)=> setReturnPolicy(e.target.value)}/>
        </div>
        <div className="mt-4">
          <p className="text-lg font-semibold pb-2">Product Color</p>
          <input type="text" className="input-loyalty2"  value={productColor}
            onChange={(e)=> setProductColor(e.target.value)}/>
        </div>
        <div className="mt-4">
          <p className="text-lg font-semibold pb-2">Product Size</p>
          <input type="text" className="input-loyalty2"  value={productSize}
